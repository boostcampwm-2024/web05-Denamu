...
describe("BoardContent", () => {
  it("script 태그를 제거하고 안전한 태그만 렌더링해야 한다", () => {
    render(<BoardContent content='<p>안내</p><script>alert("xss")</script>' />);
  ...
  it("onerror 같은 이벤트 핸들러 속성을 제거해야 한다", () => {
    render(<BoardContent content='<img src="x" onerror="alert(1)" />' />);
  ...
  it("일반 서식 태그(b, a)는 그대로 렌더링해야 한다", () => {
    render(<BoardContent content='<b>굵게</b> <a href="https://denamu.dev">링크</a>' />);
