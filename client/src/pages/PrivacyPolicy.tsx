        ...
        <div className="mt-12 space-y-12">
          <Article id={1} title="개인정보의 처리 목적">
            ...
            <Ol>
              ...
              <Li label="Q&A 문의 접수 및 답변 통지">
                회원 및 비회원의 Q&A 문의 접수, 답변 처리, 답변 등록 사실의 이메일 통지, 비공개 문의의 작성자 본인
                확인을 목적으로 개인정보를 처리합니다.
              </Li>
              <Li label="서비스 이용 통계 분석 및 개선">
                서비스 이용에 대한 분석, 인구통계학적 분석 및 서비스 개선을 목적으로 개인정보를 처리합니다.
              </Li>
              <Li label="부정이용 방지 및 서비스 안전 확보">
                개발자 채팅 등 실시간 서비스에서 발생하는 스팸, 욕설, 불법 게시물 등 부정이용을 방지하고 신고·분쟁 발생
                시 사실관계를 확인하기 위하여 접속 IP와 이용 기록을 처리합니다.
              </Li>
              <Li label="마케팅 활용 및 광고성 정보 안내 (선택)">
                신규 기능, 이벤트, 프로모션 등 광고성 정보를 이메일로 안내하기 위한 목적으로 개인정보를 처리합니다.
                정보주체의 별도 동의를 받은 경우에 한하여 처리하며, 동의하지 않아도 회원가입 및 서비스 이용에는 제한이
                없습니다.
              </Li>
              <Li label="서비스 이용 안내 (미접속 알림, 공지사항)">
          ...
          <Article id={2} title="처리하는 개인정보의 항목">
            ...
            <Ol>
              ...
              <Li label="Q&A 문의 등록 시">
                <Ul>
                  <li>
                    법적 근거: 회원은 「개인정보 보호법」 제15조제1항제4호(계약의 체결·이행), 비회원은 제15조제1항제1호
                    (정보주체의 동의)
                  </li>
                  <li>회원: 별도 수집 없이 가입 시 등록한 이메일로 답변 통지</li>
                  <li>
                    비회원: 닉네임, 이메일, 비밀번호(비공개 문의 및 본인 확인용) 필수 수집 — 답변 통지 및 추가 질문 시
                    본인 확인 목적으로만 이용
                  </li>
                </Ul>
              </Li>
              ...
              <Li label="개발자 채팅 이용 시">
                <Ul>
                  <li>
                    법적 근거: 「개인정보 보호법」 제15조제1항제4호(계약의 체결·이행), 부정이용 방지 목적의 IP 처리는
                    제15조제1항제6호(정당한 이익)
                  </li>
                  <li>
                    비회원(익명) 채팅 이용자를 포함하여 접속 IP, 채팅 메시지 내용, 이용 시각을 서버 로그로 기록합니다.
                  </li>
                </Ul>
              </Li>
              <Li label="이메일 수신 동의 시 (선택)">
                <Ul>
                  <li>법적 근거: 「개인정보 보호법」 제15조제1항제1호(정보주체의 동의)</li>
                  <li>항목: 이메일 주소</li>
                  <li>
                    마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 수신 여부는 회원가입 시 또는 마이페이지 &gt; 정보
                    수정에서 항목별로 개별 동의·철회할 수 있습니다.
                  </li>
                </Ul>
              </Li>
              <Li label="회원 탈퇴 시">
          ...
          <Article id={4} title="개인정보의 처리 및 보유 기간">
            ...
            <Ol>
              ...
              <Li label="Q&A 문의 정보">
                <Ul>
                  <li>회원 문의: 회원 탈퇴 시까지 보유하며, 탈퇴 시 지체 없이 파기합니다.</li>
                  <li>
                    비회원 문의(닉네임·이메일·비밀번호): 답변 완료 후 1년간 보유하며, 이후 지체 없이 파기합니다. 다만
              ...
              <Li label="개발자 채팅 로그(IP·메시지 내용)">
                <Ul>
                  <li>부정이용 방지 및 분쟁 대응 목적으로 서버 로그 파일에 최대 30일간 보관 후 자동 파기됩니다.</li>
                </Ul>
              </Li>
              <Li label="이메일 수신 동의 정보">
                <Ul>
                  <li>
                    마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 수신 동의 정보는 동의를 철회하거나 회원 탈퇴
                    시까지 보유하며, 이후 지체 없이 파기합니다.
                  </li>
                </Ul>
              </Li>
            </Ol>
                ...
                <tbody>
                  ...
                  <tr className="border-t border-gray-200">
                    ...
                    <td className="px-4 py-3">
                      홈페이지 이용자 접속 및 이용 통계 분석, 이메일 발송 (회원 인증, 비밀번호 재설정, RSS 등록 신청
                      결과 통지, Q&A 답변 등록 통지, 마케팅 활용 및 광고성 정보 안내, 미접속 알림, 공지사항 안내)
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-gray-200">
                    <td className="px-4 py-3">Google LLC</td>
                    <td className="px-4 py-3">미국</td>
                    <td className="px-4 py-3">이메일 주소, 닉네임</td>
                    <td className="px-4 py-3">이메일 발송 (Q&A 답변 등록 통지)</td>
                    <td className="px-4 py-3">발송 목적 달성 시까지</td>
                  </tr>
                  <tr className="border-t border-gray-200">
                    <td className="px-4 py-3">Google LLC</td>
                    ...
                    <td className="px-4 py-3">
                      이메일 발송 (마케팅 활용 및 광고성 정보 안내, 미접속 알림, 공지사항 안내)
                    </td>
                    <td className="px-4 py-3">동의 철회 또는 회원 탈퇴 시까지</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <Ol>
              <Li label="국외이전의 법적 근거">
                <Ul>
                  ...
                  <li>
                    마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 안내 목적의 이전은 「개인정보 보호법」
                    제28조의8제1항제1호(정보주체의 동의)
                  </li>
                </Ul>
              </Li>
              <Li label="이전 일시 및 방법">
              ...
              <Li label="이전 거부 방법 및 거부 효과">
                <Ul>
                  ...
                  <li>
                    필수 이메일(회원 인증, 비밀번호 재설정, RSS 등록 신청 결과 통지)은 회원 관리에 필수적이므로 거부 시
                    서비스 이용이 제한될 수 있습니다.
                  </li>
                  <li>
                    선택 이메일(마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 안내)은 회원가입 시 또는 마이페이지
                    &gt; 정보 수정에서 항목별로 동의·철회할 수 있으며, 거부하더라도 회원가입 및 서비스 이용에는 제한이
                    없습니다.
                  </li>
                </Ul>
              </Li>
