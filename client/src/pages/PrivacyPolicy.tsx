          ...
          <Article id={1} title="개인정보의 처리 목적">
            ...
            <Ol>
              ...
              <Li label="마케팅 활용 및 광고성 정보 안내 (선택)">
                ...
                정보주체의 별도 동의를 받은 경우에 한하여 처리하며, 동의하지 않아도 회원가입 및 서비스 이용에는
                제한이 없습니다.
              </Li>
            ...
            <Ol>
              ...
              <Li label="이메일 수신 동의 시 (선택)">
                <Ul>
                  ...
                  <li>항목: 이메일 주소</li>
                  <li>
                    마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 수신 여부는 회원가입 시 또는 마이페이지 &gt;
                    정보 수정에서 항목별로 개별 동의·철회할 수 있습니다.
                  </li>
                </Ul>
              </Li>
            </Ol>
                ...
                <tbody>
                  ...
                  <tr className="border-t border-gray-200">
                    ...
                    <td className="px-4 py-3">
                      ...
                      통지, 마케팅 활용 및 광고성 정보 안내, 미접속 알림, 공지사항 안내)
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <Ol>
              ...
              <Li label="이전 거부 방법 및 거부 효과">
                <Ul>
                  ...
                  <li>
                    필수 이메일(회원 인증, 비밀번호 재설정, RSS 등록 신청 결과 통지)은 회원 관리에 필수적이므로 거부
                    시 서비스 이용이 제한될 수 있습니다.
                  </li>
                  <li>
                    선택 이메일(마케팅 활용 및 광고성 정보, 미접속 알림, 공지사항 안내)은 회원가입 시 또는
                    마이페이지 &gt; 정보 수정에서 항목별로 동의·철회할 수 있으며, 거부하더라도 회원가입 및 서비스
                    이용에는 제한이 없습니다.
                  </li>
                </Ul>
              </Li>
