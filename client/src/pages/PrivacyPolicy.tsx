      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section className="border-b border-gray-200 pb-10">
          ...
          <p className="mt-6 text-sm leading-7 text-gray-600">
            {SERVICE_NAME}(이하 '서비스')는 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를
            준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라
            정보주체에게 개인정보의 처리와 보호에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수
        ...
        {/* Highlights */}
        <section aria-label="주요 개인정보 처리 표시" className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="mt-12 space-y-12">
          <Article id={1} title="개인정보의 처리 목적">
            <P>
              {SERVICE_NAME}는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 외의 용도로는
            ...
            <Ol>
              ...
              <Li label="서비스 제공">
                RSS 기반 기술 블로그 큐레이션, 검색, 댓글·좋아요, 개발자 채팅 등 기본적인 서비스 제공을 목적으로 개인정보를
                처리합니다.
              </Li>
          ...
          <Article id={2} title="처리하는 개인정보의 항목">
            <P>
              {SERVICE_NAME}는 서비스 제공을 위해 필요 최소한의 범위에서 정보주체의 동의 없이 다음의 개인정보를 수집·이용하며,
              각 항목의 처리 법적 근거는 다음과 같습니다.
            </P>
            <Ol>
            ...
            <p className="text-sm leading-7 text-gray-500">
              ※ {SERVICE_NAME}는 댓글·개발자 채팅 등 공개되는 영역에 정보주체가 민감정보(사상·신념, 건강 등)를 입력하지 않도록
              주의를 권고합니다.
            </p>
          </Article>
          ...
          <Article id={3} title="14세 미만 아동의 개인정보 처리에 관한 사항">
            <P>
              {SERVICE_NAME}는 만 14세 미만 사용자의 개인정보는 수집하지 않습니다. 단, 만 14세 미만 아동의 개인정보를 처리하기
              위하여 개인정보보호법에 따른 동의를 받아야 할 때는 그 법정대리인에게 동의를 받고, 개인정보 사용이 끝나면 해당
              정보를 바로 삭제하며, 개인정보가 사용되는 동안 개인정보를 안전하게 관리합니다.
            </P>
          </Article>

          <Article id={4} title="개인정보의 처리 및 보유 기간">
            <P>
              {SERVICE_NAME}는 법령에 따른 개인정보 보유·이용 기간 또는 정보주체로부터 개인정보 수집 시 안내한 보유·이용 기간
          ...
          <Article id={5} title="개인정보의 파기 절차 및 방법">
            <P>
              {SERVICE_NAME}는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당
              개인정보를 파기합니다. 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의
            ...
            <Ol>
              ...
              <Li label="외부 서비스에 의해 처리되는 개인정보">
                Google Analytics를 통해 처리되는 개인정보는 서비스 제공자의 정책에 따라 일정 기간 보관 후 자동으로 삭제되며,
                보관 기간은 <Anchor href="#section-4">'제4조 개인정보의 처리 및 보유 기간'</Anchor>에서 확인할 수 있습니다.
              </Li>
            </Ol>
          </Article>
          ...
          <Article id={7} title="개인정보 처리업무의 위탁에 관한 사항">
            <P>{SERVICE_NAME}는 원활한 개인정보 업무 처리를 위하여 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.</P>
            ...
            <P>
              {SERVICE_NAME}는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지,
              기술적·관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리·감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에
              명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다. 위탁업무의 내용이나 수탁자가 변경될
          ...
          <Article id={8} title="개인정보의 국외 수집 및 이전에 관한 사항">
            <P>
              {SERVICE_NAME}는 서비스 이용 통계 분석을 위하여 개인정보를 국외에 이전하고 있습니다.
            </P>
            <Ol>
          ...
          <Article id={10} title="개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항">
            <P>
              {SERVICE_NAME}는 서비스 이용 과정에서 이용 정보를 저장하고 수시로 불러오는 '쿠키(Cookie)'를 사용합니다. 쿠키는
              웹사이트 운영에 이용되는 서버(http)가 정보주체의 브라우저에 보내는 소량의 정보로서 정보주체의 컴퓨터 또는
              모바일에 저장됩니다.
            </P>
            <Ol>
              <Li label="쿠키의 사용 목적">
            ...
            <div className="mt-4 rounded-lg bg-gray-50 p-5">
              ...
              <details className="mt-2 text-sm text-gray-600">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5">
                  <li>크롬(Chrome): 우측 상단 '⋮' &gt; 설정 &gt; 개인정보 보호 및 보안 &gt; 쿠키 및 기타 사이트 데이터</li>
          ...
          <Article id={12} title="정보주체와 법정대리인의 권리·의무 및 행사방법에 관한 사항">
            <P>
              정보주체는 {SERVICE_NAME}에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 및 동의 철회 등을 요구할 수 있습니다.
              회원은 서비스 내 프로필 수정 및 회원 탈퇴 기능을 통해 직접 개인정보를 조회·수정하거나 삭제할 수 있으며, 아래 연락처를
              통해서도 권리 행사를 요청할 수 있습니다.
            </P>
            <P>
              권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수도 있습니다. {SERVICE_NAME}는 권리
              행사를 한 자가 본인이거나 정당한 대리인인지를 확인하며, 청구를 받은 날로부터 10일 이내에 회신하겠습니다.
            </P>
          </Article>

          <Article id={13} title="개인정보 보호책임자에 관한 사항">
            <P>
              {SERVICE_NAME}는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및
          ...
          <Article id={14} title="정보주체의 권익침해에 대한 구제방법">
            ...
            <Ol>
              <Li>
                개인정보 분쟁조정위원회: (국번없이) 1833-6972 (<ExternalLink href="https://www.kopico.go.kr">www.kopico.go.kr</ExternalLink>)
              </Li>
              <Li>
                개인정보침해 신고센터: (국번없이) 118 (<ExternalLink href="https://privacy.kisa.or.kr">privacy.kisa.or.kr</ExternalLink>)
              </Li>
              <Li>
